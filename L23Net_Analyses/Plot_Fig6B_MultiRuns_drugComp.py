...
fig_snr_PN, ax_snr_PN = plt.subplots(figsize=(7, 6))
fig_percentsilent, ax_percentsilent = plt.subplots(figsize=(6, 5))
fig_percentsilent_PN, ax_percentsilent_PN = plt.subplots(figsize=(7, 6))
for cind, cond in enumerate(conds):
	...
	if ((pval_PV_0 < p_thresh) & (abs(cd_PV_0) > c_thresh) & (cind>0)):
		ax_rates.text(x[cind][2],meanRates[2]+stdevRates[2]+2,'*',c='k',va='bottom' if ((pval_PV < p_thresh) & (abs(cd_PV) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
...
df.to_csv('figsV1_benzo_V2/stats_Rates.csv')

ax_rates.set_ylabel('Firing Rate (Hz)')
ax_rates.set_xticks([int(x_types[i]*len(x)+(len(x))/2 + i) - 0.5 for i in range(1,len(x_labels_types))])
...
fig_rates.savefig('figsV1_benzo_V2/Rates.png',dpi=300,transparent=True)

ax_rates_PN.set_ylabel('Baseline (Hz)')
ax_rates_PN.set_xticks(x_PN)
ax_rates_PN.set_xlim(-0.6,3.6)
...
fig_rates_PN.savefig('figsV1_benzo_V2/Rates_PN.png',dpi=300,transparent=True)

ax_stimrates.set_ylabel('Post-stimulus')
ax_stimrates.set_xticks([int(x_types[i]*len(x)+(len(x))/2 + i) - 0.5 for i in range(1,len(x_labels_types))])
...
fig_stimrates.savefig('figsV1_benzo_V2/StimRates.png',dpi=300,transparent=True)
...
fig_stimrates_PN.savefig('figsV1_benzo_V2/StimRates_PN.png',dpi=300,transparent=True)

ax_snr.set_ylabel('SNR')
ax_snr.set_xticks([int(x_types[i]*len(x)+(len(x))/2 + i) - 0.5 for i in range(1,len(x_labels_types))])
ax_snr.set_xticklabels(x_labels_types[1:])
ax_snr.grid(False)
ax_snr.spines['right'].set_visible(False)
ax_snr.spines['top'].set_visible(False)
fig_snr.tight_layout()
fig_snr.savefig('figsV1_benzo_V2/SNR.png',dpi=300,transparent=True)

ax_snr_PN.set_ylabel('SNR')
ax_snr_PN.set_xticks(x_PN)
ax_snr_PN.set_xlim(-0.6,3.6)
...
fig_snr_PN.savefig('figsV1_benzo_V2/SNR_PN.png',dpi=300,transparent=True)

ax_percentsilent.set_ylabel('% Silent')
ax_percentsilent.set_xticks([int(x_types[i]*len(x)+(len(x))/2 + i) - 0.5 for i in range(1,len(x_labels_types))])
...
fig_percentsilent.savefig('figsV1_benzo_V2/PercentSilent.png',dpi=300,transparent=True)

ax_percentsilent_PN.set_ylabel('Pyr % Silent')
ax_percentsilent_PN.set_xticks(x_PN)
ax_percentsilent_PN.set_xlim(-0.6,3.6)
...
fig_percentsilent_PN.savefig('figsV1_benzo_V2/PercentSilent_PN.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.savefig('figsV1_benzo_V2/PercentRecovery_PNvsBehaviour_SeedBySeed.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1_benzo_V2/PercentRecovery_PNvsBehaviour_MeansDivision.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1_benzo_V2/PercentRecovery_PNvsBehaviour_Hybrid.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1_benzo_V2/PercentRecovery_PNvsBehaviour_Distribution.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1_benzo_V2/PercentRecovery_PNvsBehaviour_HybridBootstrapped.png',dpi=300,transparent=True)
plt.close()
...
fig.savefig('figsV1_benzo_V2/Spikes_PSD_Boot95CI_PN.png',bbox_inches='tight',dpi=300, transparent=True)
plt.close()
