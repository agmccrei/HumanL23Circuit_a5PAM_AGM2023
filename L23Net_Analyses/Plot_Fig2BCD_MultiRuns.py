...
fig_rates, ax_rates = plt.subplots(figsize=(6, 6))
...
fig_rates_bp, ax_rates_bp = plt.subplots(figsize=(6, 5))
...
for cind, cond in enumerate(conds):
	...
	if ((pval_SST_0 < p_thresh) & (abs(cd_SST_0) > c_thresh) & (cind>0)):
		ax_rates.text(x[cind][1],meanRates[1]+stdevRates[1]+2,'*',c='k',va='bottom' if ((pval_SST < p_thresh) & (abs(cd_SST) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
		ax_rates_bp.text(x[cind][1],np.max(np.transpose(rates[cind])[1])+2,'*',c='k',va='bottom' if ((pval_SST < p_thresh) & (abs(cd_SST) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
	if ((pval_SST < p_thresh) & (abs(cd_SST) > c_thresh) & (cind>0)):
		ax_rates.text(x[cind][1],meanRates[1]+stdevRates[1]+2,'*',c=colors_conds[1],va='top' if ((pval_SST_0 < p_thresh) & (abs(cd_SST_0) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
		ax_rates_bp.text(x[cind][1],np.max(np.transpose(rates[cind])[1])+2,'*',c=colors_conds[1],va='top' if ((pval_SST_0 < p_thresh) & (abs(cd_SST_0) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
	if ((pval_PV_0 < p_thresh) & (abs(cd_PV_0) > c_thresh) & (cind>0)):
		ax_rates.text(x[cind][2],meanRates[2]+stdevRates[1]+2,'*',c='k',va='bottom' if ((pval_PV < p_thresh) & (abs(cd_PV) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
		ax_rates_bp.text(x[cind][2],np.max(np.transpose(rates[cind])[2])+2,'*',c='k',va='bottom' if ((pval_PV < p_thresh) & (abs(cd_PV) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
	if ((pval_PV < p_thresh) & (abs(cd_PV) > c_thresh) & (cind>0)):
		ax_rates.text(x[cind][2],meanRates[2]+stdevRates[2]+2,'*',c=colors_conds[1],va='top' if ((pval_PV_0 < p_thresh) & (abs(cd_PV_0) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
		ax_rates_bp.text(x[cind][2],np.max(np.transpose(rates[cind])[2])+2,'*',c=colors_conds[1],va='top' if ((pval_PV_0 < p_thresh) & (abs(cd_PV_0) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
	if ((pval_VIP_0 < p_thresh) & (abs(cd_VIP_0) > c_thresh) & (cind>0)):
		ax_rates.text(x[cind][3],meanRates[3]+stdevRates[3]+2,'*',c='k',va='bottom' if ((pval_VIP < p_thresh) & (abs(cd_VIP) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
		ax_rates_bp.text(x[cind][3],np.max(np.transpose(rates[cind])[3])+2,'*',c='k',va='bottom' if ((pval_VIP < p_thresh) & (abs(cd_VIP) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
	if ((pval_VIP < p_thresh) & (abs(cd_VIP) > c_thresh) & (cind>0)):
		ax_rates.text(x[cind][3],meanRates[3]+stdevRates[3]+2,'*',c=colors_conds[1],va='top' if ((pval_VIP_0 < p_thresh) & (abs(cd_VIP_0) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
		ax_rates_bp.text(x[cind][3],np.max(np.transpose(rates[cind])[3])+2,'*',c=colors_conds[1],va='top' if ((pval_VIP_0 < p_thresh) & (abs(cd_VIP_0) > c_thresh)) else 'top', ha='center',fontweight='bold',fontsize=fsize)
...
df.to_csv('figsV1/stats_Rates.csv')
df_SST.to_csv('figsV1/stats_Rates_SST.csv')
df_PV.to_csv('figsV1/stats_Rates_PV.csv')
df_VIP.to_csv('figsV1/stats_Rates_VIP.csv')

ax_rates.set_ylabel('Baseline Rate (Hz)')
...
fig_rates.savefig('figsV1/Rates.png',dpi=300,transparent=True)

ax_rates_bp.set_ylabel('Baseline Rate (Hz)')
...
fig_rates_bp.savefig('figsV1/Rates_bp.png',dpi=300,transparent=True)
...
fig_rates_PN.savefig('figsV1/Rates_PN.png',dpi=300,transparent=True)
...
fig_rates_PN_bp.savefig('figsV1/Rates_PN_bp.png',dpi=300,transparent=True)
...
fig_stimrates.savefig('figsV1/StimRates.png',dpi=300,transparent=True)
...
fig_stimrates_bp.savefig('figsV1/StimRates_bp.png',dpi=300,transparent=True)
...
fig_stimrates_PN.savefig('figsV1/StimRates_PN.png',dpi=300,transparent=True)
...
fig_stimrates_PN_bp.savefig('figsV1/StimRates_PN_bp.png',dpi=300,transparent=True)
...
fig_snr.savefig('figsV1/SNR.png',dpi=300,transparent=True)
...
fig_snr_bp.savefig('figsV1/SNR_bp.png',dpi=300,transparent=True)
...
fig_snr_PN.savefig('figsV1/SNR_PN.png',dpi=300,transparent=True)
...
fig_snr_PN_bp.savefig('figsV1/SNR_PN_bp.png',dpi=300,transparent=True)
...
fig_percentsilent.savefig('figsV1/PercentSilent.png',dpi=300,transparent=True)
...
fig_percentsilent_bp.savefig('figsV1/PercentSilent_bp.png',dpi=300,transparent=True)
...
fig_percentsilent_PN.savefig('figsV1/PercentSilent_PN.png',dpi=300,transparent=True)
...
fig_percentsilent_PN_bp.savefig('figsV1/PercentSilent_PN_bp.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.savefig('figsV1/PercentRecovery_PNvsBehaviour_SeedBySeed.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1/PercentRecovery_PNvsBehaviour_MeansDivision.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1/PercentRecovery_PNvsBehaviour_Hybrid.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1/PercentRecovery_PNvsBehaviour_Distribution.png',dpi=300,transparent=True)
plt.close()
...
fig_recov.tight_layout()
fig_recov.savefig('figsV1/PercentRecovery_PNvsBehaviour_HybridBootstrapped.png',dpi=300,transparent=True)
plt.close()
...
fig.savefig('figsV1/Spikes_PSD_Boot95CI_PN.png',bbox_inches='tight',dpi=300, transparent=True)
plt.close()
